        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidateEmailCheck", "Email LIKE '_%@_%._%' ");
                    table.CheckConstraint("GymUserValidatePhoneCheck", "Phone Like '01%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PlanValidateDurationCheck", "Duration Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidateEmailCheck1", "Email LIKE '_%@_%._%' ");
                    table.CheckConstraint("GymUserValidatePhoneCheck1", "Phone Like '01%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SessionValidateCapacityCheck", "Capacity Between 1 and 25");
                    table.CheckConstraint("SessionValidateStartEndTimeCheck", "EndDate > StartDate");
                    table.ForeignKey(
