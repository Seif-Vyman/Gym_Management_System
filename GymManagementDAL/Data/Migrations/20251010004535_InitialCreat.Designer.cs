...
namespace GymManagementDAL.Data.Migrations
{
    ...
    [Migration("20251010004535_InitialCreat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("GymUserValidateEmailCheck", "Email LIKE '_%@_%._%' ");

                            t.HasCheckConstraint("GymUserValidatePhoneCheck", "Phone Like '01%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%' ");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("Plans", t =>
                        {
                            t.HasCheckConstraint("PlanValidateDurationCheck", "Duration Between 1 and 365");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Session", b =>
                {
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            t.HasCheckConstraint("SessionValidateCapacityCheck", "Capacity Between 1 and 25");

                            t.HasCheckConstraint("SessionValidateStartEndTimeCheck", "EndDate > StartDate");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Trainer", b =>
                {
                    ...
                    b.ToTable("Trainers", t =>
                        {
                            t.HasCheckConstraint("GymUserValidateEmailCheck", "Email LIKE '_%@_%._%' ")
                                .HasName("GymUserValidateEmailCheck1");

                            t.HasCheckConstraint("GymUserValidatePhoneCheck", "Phone Like '01%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%' ")
                                .HasName("GymUserValidatePhoneCheck1");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    b.OwnsOne("GymManagementDAL.Entities.Adress", "Address", b1 =>
                        {
